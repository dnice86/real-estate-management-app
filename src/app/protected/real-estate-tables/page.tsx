...
// Column definitions for each table using the new simplified approach
                ...
                <div className="px-4 lg:px-6">
                  <div className="mb-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Real Estate Management interface powered by database functions with explicit parameters
                    </p>
                  </div>
